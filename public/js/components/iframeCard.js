export function buildIframeCard(block = {}) {
  ...
  if (url) {
    container.innerHTML = `<iframe src="${escapeHtml(url)}" style="width:100%;height:100%;min-height:300px;border:none;border-radius:var(--radius);" sandbox="allow-scripts allow-same-origin"></iframe>`;
  } else {
