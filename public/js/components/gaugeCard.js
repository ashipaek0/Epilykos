export function buildGaugeCard(block = {}) {
  ...
  container.innerHTML = `
    <div class="stat-label">${escapeHtml(config.title || 'Gauge')}</div>
    <div class="gauge-wrap" style="position:relative;width:200px;height:200px;margin:0.5rem auto;">
      ...
      <div class="stat-value" style="position:absolute;inset:0;display:flex;align-items:center;justify-content:center;font-size:2rem;font-weight:600;" id="gauge-val-${block.id}">--</div>
    </div>`;
  return container;
}
